...
/**
 * <p>
 * Activity for testing In-App-Routing with Roots SDK. The URL filtering rule and
 * param names are specified as a metadata for this Activity in manifest. Upon seeing a match with
 * app link url or with a fallback url Roots SDK launches this activity. The parameter name in the url format is
